...
<div class="container-fluid d-flex justify-content-center align-items-center" style="background-color: #662222; min-height: 100vh;">
    <div class="card auth-card border-0 shadow-lg" style="background-color: #FFF5E1; border-radius: 30px; width: 600px; padding: 30px;">
        <div class="text-center mb-3">
            ...
            <h5 class="fw-bold" style="color: #4A2C2C;">Login Siswa</h5>
            <p class="text-muted small mb-0">Masukkan akun yang sudah dibuat oleh Admin.</p>
        </div>
        ...
        <form action="{{ route('login.post') }}" method="POST">
            ...
            <div class="mb-2">
                <label class="form-label text-start w-100 small fw-bold mb-1" style="color: #662222;">NIS</label>
                <input type="text" name="nis" class="form-control" style="background-color: transparent; border-color: #662222; border-radius: 10px;" placeholder="Masukkan NIS">
            </div>
